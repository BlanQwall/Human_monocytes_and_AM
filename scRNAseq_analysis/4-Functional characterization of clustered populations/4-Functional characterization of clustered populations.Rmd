...
results <- readRDS(file = "./so.merged_clusters.seuratObject.Rds")
```
...
DotPlot(results.c2, features = c("MCEMP1", "INHBA", "FBP1", 
                                 ...
                                 "MT1M", "MT1H", "MT1A"), 
                    scale.by = "size",
                    cols = c("dark blue", "dark red"))  + theme(axis.text.x =  element_text(angle = 45, hjust=1))+ 
